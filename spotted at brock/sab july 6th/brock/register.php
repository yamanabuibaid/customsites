			...
			<div style="display: inline-block;width:100%;">
				<div class="side right">
					<form method="post" class="form-register">
						<?php
							if(isset($_POST['submit_register'])){
								...
								if($password == $verify_password){
									mysql_query("INSERT INTO users VALUES('','$name','$email2','$username','$password','no','a','user')");
						...
						<input type="text" class="input-register" name="username" placeholder="Username" pattern="[A-Za-z].{6,}[0-9]">
